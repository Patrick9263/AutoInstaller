...
# $discordLink = "https://discordapp.com/api/download?platform=win"
# $Link = "https://code.visualstudio.com/docs/?dv=win"
# $Link = "https://updates.twitchapp.net/windows/installer/TwitchSetup.exe"
# $Link = "https://download.jetbrains.com/product?code=TBA&distribution=windows"
# $Link = 
# $Link = 
# $Link = 
...
# $Link = 
# $Link = "https://riotgamespatcher-a.akamaihd.net/releases/live/installer/deploy/League%20of%20Legends%20installer%20NA.exe"
# $Link = 
# $Link = 
# $Link = 
# $Link = 
